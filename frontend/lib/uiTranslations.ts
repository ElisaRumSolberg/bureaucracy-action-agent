...
const STRINGS: Record<string, Record<UILanguage, string>> = {
  ...
  "Welcome to Bureaucracy Action Agent": {
    Türkçe: "Bureaucracy Action Agent'a hoş geldiniz",
    Norsk: "Velkommen til Bureaucracy Action Agent",
    Deutsch: "Willkommen bei Bureaucracy Action Agent",
    Français: "Bienvenue sur Bureaucracy Action Agent",
    Español: "Bienvenido a Bureaucracy Action Agent",
  },
  "Sign in to save your documents and access them from any device.": {
    Türkçe: "Belgelerinizi kaydetmek ve her cihazdan erişebilmek için giriş yapın.",
    Norsk: "Logg inn for å lagre dokumentene dine og få tilgang fra hvilken som helst enhet.",
    Deutsch: "Melden Sie sich an, um Ihre Dokumente zu speichern und von jedem Gerät darauf zuzugreifen.",
    Français: "Connectez-vous pour enregistrer vos documents et y accéder depuis n'importe quel appareil.",
    Español: "Inicia sesión para guardar tus documentos y acceder a ellos desde cualquier dispositivo.",
  },
  "Continue without signing in": {
    Türkçe: "Giriş yapmadan devam et",
    Norsk: "Fortsett uten å logge inn",
    Deutsch: "Ohne Anmeldung fortfahren",
  ...
  "Signed in as": {
    ...
    Deutsch: "Angemeldet als",
    Français: "Connecté en tant que",
    Español: "Sesión iniciada como",
  },
  Continue: {
    Türkçe: "Devam et",
    Norsk: "Fortsett",
  ...
  "Risk Radar": {
    ...
    Norsk: "Risikoradar",
    Deutsch: "Risikoradar",
    Français: "Radar de risques",
    Español: "Radar de riesgos",
  },
  "deadlines approaching": {
    Türkçe: "yaklaşan son tarih",
    Norsk: "nærmende frister",
    Deutsch: "nahende Fristen",
    Français: "échéances proches",
    Español: "plazos próximos",
  },
  "tasks blocked": {
    Türkçe: "engellenmiş görev",
    Norsk: "blokkerte oppgaver",
    Deutsch: "blockierte Aufgaben",
    Français: "tâches bloquées",
    Español: "tareas bloqueadas",
  },
  "conditions unanswered": {
    Türkçe: "yanıtsız koşul",
    Norsk: "ubesvarte betingelser",
    Deutsch: "unbeantwortete Bedingungen",
    Français: "conditions sans réponse",
    Español: "condiciones sin responder",
  },
  "details missing": {
    Türkçe: "eksik detay",
  ...
  "Nothing needs attention right now.": {
    Türkçe: "Şu anda dikkat gerektiren bir şey yok.",
    Norsk: "Ingenting krever oppmerksomhet akkurat nå.",
    Deutsch: "Im Moment erfordert nichts Aufmerksamkeit.",
    Français: "Rien ne nécessite d'attention pour le moment.",
    Español: "Nada requiere atención en este momento.",
  },
  "Scheduling conflicts": {
    Türkçe: "Zamanlama çakışmaları",
    Norsk: "Tidsplankonflikter",
    Deutsch: "Terminkonflikte",
  ...
  "Case Overview": {
    Türkçe: "Dosya Özeti",
    Norsk: "Sakoversikt",
    Deutsch: "Fallübersicht",
    Français: "Aperçu du dossier",
    Español: "Resumen del caso",
  },
  "actions extracted": {
    Türkçe: "eylem çıkarıldı",
    Norsk: "handlinger hentet ut",
    Deutsch: "Aktionen extrahiert",
    Français: "actions extraites",
    Español: "acciones extraídas",
  },
  "Next action available": {
    Türkçe: "Sıradaki eylem hazır",
    Norsk: "Neste handling tilgjengelig",
    Deutsch: "Nächste Aktion verfügbar",
    Français: "Prochaine action disponible",
    Español: "Próxima acción disponible",
  },
  "No next action yet": {
    Türkçe: "Henüz sıradaki eylem yok",
    Norsk: "Ingen neste handling ennå",
    Deutsch: "Noch keine nächste Aktion",
    Français: "Pas encore de prochaine action",
    Español: "Aún no hay próxima acción",
  },
  Cases: {
    Türkçe: "Dosyalar",
    Norsk: "Saker",
  ...
  "Group related documents (e.g. a visa application) to see their tasks in one place with one shared next action.": {
    Türkçe:
      "İlgili belgeleri (ör. bir vize başvurusu) gruplayın; görevlerini tek bir yerde, tek bir ortak sıradaki eylemle görün.",
    Norsk:
      "Grupper relaterte dokumenter (f.eks. en visumsøknad) for å se oppgavene deres på ett sted med én felles neste handling.",
    Deutsch:
      "Gruppieren Sie zusammengehörige Dokumente (z. B. einen Visumantrag), um ihre Aufgaben an einem Ort mit einer gemeinsamen nächsten Aktion zu sehen.",
    Français:
      "Regroupez des documents liés (ex. une demande de visa) pour voir leurs tâches au même endroit avec une seule action suivante partagée.",
    Español:
      "Agrupa documentos relacionados (p. ej. una solicitud de visa) para ver sus tareas en un solo lugar con una única acción siguiente compartida.",
  },
  "New case name…": {
    Türkçe: "Yeni dosya adı…",
    Norsk: "Nytt saksnavn…",
    Deutsch: "Neuer Fallname…",
    Français: "Nom du nouveau dossier…",
    Español: "Nombre del nuevo caso…",
  },
  Create: {
    Türkçe: "Oluştur",
    Norsk: "Opprett",
  ...
  "No cases yet.": {
    Türkçe: "Henüz dosya yok.",
    Norsk: "Ingen saker ennå.",
    Deutsch: "Noch keine Fälle.",
    Français: "Aucun dossier pour le moment.",
    Español: "Aún no hay casos.",
  },
  document: {
    Türkçe: "belge",
    Norsk: "dokument",
  ...
  "← Back to cases": {
    Türkçe: "← Dosyalara dön",
    Norsk: "← Tilbake til saker",
    Deutsch: "← Zurück zu Fällen",
    Français: "← Retour aux dossiers",
    Español: "← Volver a los casos",
  },
  "Back to cases": {
    Türkçe: "Dosyalara dön",
    Norsk: "Tilbake til saker",
  ...
  "Delete case": {
    Türkçe: "Dosyayı sil",
    Norsk: "Slett sak",
    Deutsch: "Fall löschen",
    Français: "Supprimer le dossier",
    Español: "Eliminar caso",
  },
  "Delete this case? Its documents will not be deleted.": {
    Türkçe: "Bu dosya silinsin mi? İçindeki belgeler silinmeyecek.",
    Norsk: "Slette denne saken? Dokumentene i den vil ikke bli slettet.",
    Deutsch: "Diesen Fall löschen? Die enthaltenen Dokumente werden nicht gelöscht.",
    Français: "Supprimer ce dossier ? Ses documents ne seront pas supprimés.",
    Español: "¿Eliminar este caso? Sus documentos no se eliminarán.",
  },
  "From:": {
    Türkçe: "Kaynak:",
    Norsk: "Fra:",
  ...
  "Add an existing document…": {
    Türkçe: "Mevcut bir belge ekle…",
    Norsk: "Legg til et eksisterende dokument…",
    Deutsch: "Vorhandenes Dokument hinzufügen…",
    Français: "Ajouter un document existant…",
    Español: "Añadir un documento existente…",
  },
  Add: {
    Türkçe: "Ekle",
    Norsk: "Legg til",
  ...
  "No documents in this case yet.": {
    Türkçe: "Bu dosyada henüz belge yok.",
    Norsk: "Ingen dokumenter i denne saken ennå.",
    Deutsch: "Noch keine Dokumente in diesem Fall.",
    Français: "Aucun document dans ce dossier pour le moment.",
    Español: "Aún no hay documentos en este caso.",
  },
  "Remove from case": {
    Türkçe: "Dosyadan kaldır",
    Norsk: "Fjern fra sak",
    Deutsch: "Aus Fall entfernen",
    Français: "Retirer du dossier",
    Español: "Quitar del caso",
  },
  "Action plan": {
    Türkçe: "Eylem planı",
    Norsk: "Handlingsplan",
